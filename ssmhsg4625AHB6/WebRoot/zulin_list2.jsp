...
-->
 ...
 <script language="javascript">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="zulinList2.do" name="myform" method="post">
    ...
    <td>${u.zongjia}</td>
    <td>${u.zulinren}</td>
    <td align='center'>${u.iszf}  <c:if test="${u.iszf=='否'}"><input type="button" value="支付" onclick="zhifu(${u.id},'zulin')"/></c:if>  </td>
    <td align='center'>${u.issh} </td>
		 ...
		 <%
			String sql="select * from zulin where zulinren='"+(String)request.getSession().getAttribute("username")+"' and issh='否' ";
...
while(RS_result.next()){
		...
		共计总价:<%=zongjiaz%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="zulinList2.do?page=1" >首页</a>
             <a href="zulinList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="zulinList2.do?page=${page.page+1 }">下一页</a>
			<a href="zulinList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
